...
**Data Sources and Extraction Process**: Reports sourced from Portfolio and market data, CSV data exports, Historical portfolio data, Internal Fitch repositories, Fitch Data Governance Policy transformed using processing pipelines.
